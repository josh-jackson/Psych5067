...
Use the mtcars dataset that is a part of base R to answer the questions below
...
4. Graph the relationship between horse power and transmission type (to do so you create predicted probabilities across the range of Xs).
...
Extra credit: re-run all of these these using the BRMS package
