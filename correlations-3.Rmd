...
- ie relationships
- to look at continuous variable assocaitions we need to think in terms of how variables relate to one another
...
- Again, best to do these tests in another framework (e.g., interaction, SEM)
