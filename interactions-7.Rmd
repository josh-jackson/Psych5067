...
check out jtools package to look at interactions and AMPPS paper on visualizing interactions **
...
<img src="~/Box Sync/5067 Regression Spring/Spring_2019/3d.png" width="750" height="550"/>
...
<img src="~/Box Sync/5067 Regression Spring/5067 spring 18/interactions pic.jpg" width="500" height="400"/>
...
- Sort of poor to model non linear data but useful to know
...
library(ggplot2)
mtcars2 <- read.csv("~/Box Sync/5067 Regression Spring/Spring_2019/mtcars2.csv")
