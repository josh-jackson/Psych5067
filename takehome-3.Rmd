...
Please use the th.project.3 dataset to answer the questions below. These data were from a study where physical health was predicted by a happyness measure, socioeconomic status, number of close friends, and a 16 week mood intervention where here was a waitlist control group (0), a . 
