...
1. Calculate the semi-partial and a partial correlation for health and friends, controlling for SES and happiness using a series of simple regression analyses (ie do not use a function for semi-partial and partial correlations). 
