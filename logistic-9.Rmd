...
## 
<img src="/Users/Jackson/Box Sync/5067 Regression Spring/5067 spring 18/Log.1.png" width="750" height="550"/>

##
<img src="/Users/Jackson/Box Sync/5067 Regression Spring/5067 spring 18/Log.2.png" width="750" height="550"/>

##
<img src="/Users/Jackson/Box Sync/5067 Regression Spring/5067 spring 18/Log.3.png" width="750" height="550"/>
...
<img src="/Users/Jackson/Box Sync/5067 Regression Spring/5067 spring 18/Log.4.png" width="550" height="350"/>
...
mortality$premature.d <- dplyr::recode(mortality$premature.d, normal ="1", premature="0")
  
mortality$premature.d <- as.numeric(as.character(mortality$premature.d))
...
death.1 <- lm(premature.d ~ Intelligence_Self , data = mortality)
summary(death.1)
```
...
death.2 <- glm(premature.d ~ Intelligence_Self , data = mortality)
summary(death.2)
```
...
##
```{r}
death.3 <- glm(premature.d ~ Intelligence_Self,
...
##
```{r}
death.4 <- glm(premature.d ~ Intelligence_Self,
...
```{r, eval =FALSE}
num.rejects <- glm(rejections ~ Intelligence_SelF, 
...
# - more/less variability than expected under the assumed distribution
# - normal linear model based on gausian normal mean and sd are independent
# - overdispersion leads to biases parameter estimates and standard errors
# - can adjust for it
```
