...
- Keeping track/sharing: osf, github 
- Keep it interesting: shiny apps
- Keep it simple and readable: tidyverse (strongly recommended)
...
- quantitative (continuous) vs qualitative (categorical/discrete)

- how you measure your variables determine your analytic tool options

## Theoretical probability and sampling distributions
