...
library(tidyverse)
library(readr)
example.data <- read_csv("~/Box Sync/5067 Regression Spring/Spring_2019/example.data.csv")
...
## Contrast coding coding

- As our models get more complex our coding schemes can too
- The basic interpretation of intercept and regression coefficient is the same regardless of coding
...
![](~/Box Sync/5067 Regression Spring/Spring_2019/intermission.gif)
...
- Previously you have seen this looking at Eta Squared, SS Error and visualizing observations around group means
...
$$ \hat{Y} = \bar{Y} $$
- Regression can be thought of as: E(Y|X)
