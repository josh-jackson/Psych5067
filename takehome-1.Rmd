...
=======
#### Please answer the questions below. Show all your code and results. You will need to use the Dawtry et al., 2015 Psychological Science article and the accompanying dataset to answer questions 3 - 11. ####
>>>>>>> 3d026a6ff19ef6ef23bd4be21cdee9fddafb84ac
...
8. Dichotomize the political preferences data into a dichotomous conservative and democrat variable, assuming the midpoint is conservative. Run bi-serial correlation. Now run a t-test. Run a Pearson Correlation. Run a one-way ANOVA. Then run a point bi-serial correlation. Any interesting commonalities or differences across the tests? 
