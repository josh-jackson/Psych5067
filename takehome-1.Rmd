...
8. Dichotomize the political preferences data into a dichotomous conservative and democrat variable, assuming the midpoint is conservative. Run a t-test with redistribution. Run a Pearson Correlation. Run a one-way ANOVA. Then run a linear model with dummy coding. Then run a linear model with effects coding. Any interesting commonalities or differences across the tests? 
